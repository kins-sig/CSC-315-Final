...
//
//        if (message.equals(R.string.cis_building)){
...
//        }
//        else if (message.equals(R.string.trask_coliseum_building)){
//            buildingName.setText(R.string.trask_coliseum_building);
...
//        }
//        else if (message.equals(R.string.bear_building)){
